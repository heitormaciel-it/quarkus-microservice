package br.com.shopi.product.dto;

import java.io.Serializable;
import java.math.BigDecimal;

public class ProductDTO {
	//private static final long serialVersionUID = 7981030801988477016L;
	...
	public ProductDTO(Long productCode, Long barCode, String referenceCode, String internalCode, String productName,
			Long status, Long groupCode, Long colorCode, Long sizeCode, BigDecimal costValue, BigDecimal saleValue,
	...
	public String toString() {
		return "ProductDTO [productCode=" + productCode + ", barCode=" + barCode + ", referenceCode=" + referenceCode
				+ ", internalCode=" + internalCode + ", productName=" + productName + ", status=" + status + ", groupCode="
